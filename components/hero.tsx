  ...
  return (
    <div className="py-16">
      ...
      <div className="mt-6 flex gap-2">
        <button className="button-secondary">Resume / CV</button>
      ...
      <div className="mt-8 flex gap-3 pl-1">
        ...
        >
          ...
          <span className="pointer-events-none absolute bottom-full left-2/3 mb-2 -translate-x-1/2 rounded bg-neutral-900 px-2 py-1 text-xs whitespace-nowrap text-white opacity-0 transition-opacity group-hover:opacity-100">
            Twitter
          </span>
        </a>
