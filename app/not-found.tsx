...
const links = [
  { title: "Github, ", href: "https://github.com/ShahuKor" },
  { title: "LinkedIn or ", href: "https://www.linkedin.com/in/shahukor/" },
  { title: "Medium", href: "https://medium.com/@ShahuKor" },
];
    ...
    <div>
      <Container className="relative flex min-h-screen items-center justify-center px-8 md:pt-20 md:pb-10">
        ...
        <div className="flex flex-col items-center text-base font-medium tracking-wide text-(--color-secondary)">
          <p>
            Sorry, I am still working on this page, it will be available very
            soon!
          </p>
          <p>
          ...
          <button className="mt-10 rounded-md bg-neutral-900 px-3 py-1.5 text-sm font-medium text-neutral-100 transition-colors ease-in-out hover:bg-neutral-700 dark:bg-neutral-300 dark:text-neutral-800 dark:transition-colors dark:ease-in-out dark:hover:bg-neutral-400">
